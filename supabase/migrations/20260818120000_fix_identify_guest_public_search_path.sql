-- Fix: identify_guest_public ainda tem SET search_path TO 'public' (sem
-- 'extensions'). Embora decrypt_pii (v0.0.172) já inclua 'extensions' no
-- próprio search_path, por segurança recriamos identify_guest_public com o
-- mesmo search_path usado por list_guests_admin ('public', 'extensions'),
-- garantindo que pgp_sym_decrypt seja sempre resolvível em qualquer chamada
-- transitiva. Mesmo corpo da função — apenas o search_path muda.
