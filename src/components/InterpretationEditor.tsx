...
export function InterpretationEditor({ sessionId }: { sessionId: string }) {
  ...
  const allScales: { label: string; score: number | null; badge?: string; badgeClass?: string }[] =
    [
      ...
      { label: 'TMT Parte A', score: interpretation.tmtAScore ?? null },
      { label: 'TMT Parte B', score: interpretation.tmtBScore ?? null },
      { label: 'Fluência Animais', score: interpretation.fluenciaAnimaisScore ?? null },
      { label: 'Fluência Frutas', score: interpretation.fluenciaFrutasScore ?? null },
