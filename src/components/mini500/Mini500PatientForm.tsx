...
interface Mini500PatientFormProps {
  onSubmit: (info: Mini500PatientInfo) => void
  initialInfo?: Mini500PatientInfo
}

export function Mini500PatientForm({ onSubmit, initialInfo }: Mini500PatientFormProps) {
