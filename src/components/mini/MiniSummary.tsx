    ...
    <div className="max-w-3xl mx-auto mini-print-root">
      <style>{`
        @media print {
          ...
          .mini-print-root, .mini-print-root * { visibility: visible; }
          .mini-print-root { position: absolute; left: 0; top: 0; width: 100%; background: white; padding: 20px; }
          .mini-print-root, .mini-print-root * { color: #000 !important; background: white !important; border-color: #ccc !important; box-shadow: none !important; }
          .mini-print-hide { display: none !important; }
        }
      `}</style>
      ...
      <div className="mb-6">
        <h2 className="text-lg font-bold text-[#E6F1FF] mb-3">Resultados Detalhados</h2>
        <div className="space-y-2">
          {results.map((r) => (
            <div
              key={r.moduleId}
            ...
            >
              <div className="flex items-center gap-2 flex-1">
                <StatusIcon isPositive={r.isPositive} />
                <span className="text-sm text-[#E6F1FF]">
