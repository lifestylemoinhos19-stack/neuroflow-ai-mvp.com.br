...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      assessment_scales: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "assessment_scales_scale_id_fkey"
            columns: ["scale_id"]
            isOneToOne: false
      ...
      assessments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "assessments_profissional_id_fkey"
      ...
      responses: {
        ...
        Relationships: [
          {
            foreignKeyName: "responses_assessment_scale_id_fkey"
            columns: ["assessment_scale_id"]
            isOneToOne: false
            referencedRelation: "assessment_scales"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      can_patient_access_response: {
        Args: { p_assessment_scale_id: string }
        Returns: boolean
      }
      can_professional_access_response: {
        Args: { p_assessment_scale_id: string }
        Returns: boolean
      }
      ...
      find_session_by_scale_metadata: {
        Args: { p_guest_id?: string; p_scale_key: string; p_scale_name: string }
        Returns: {
          session_id: string
        }[]
      }
      find_session_by_scale_type: {
        Args: { p_guest_id?: string; p_scale_type: string }
        Returns: {
          session_id: string
        }[]
      }
      ...
      is_assessment_scale_accessible_by_patient: {
        Args: { p_assessment_scale_id: string }
        Returns: boolean
      }
      is_assessment_scale_accessible_by_professional: {
        Args: { p_assessment_scale_id: string }
        Returns: boolean
      }
      is_encrypted: { Args: { p_text: string }; Returns: boolean }
      is_patient_accessible_by_professional: {
        Args: { p_patient_id: string }
        Returns: boolean
      }
      is_patient_owner_for_assessment: {
        Args: { p_assessment_id: string }
        Returns: boolean
      }
      is_patient_professional_for_assessment: {
        Args: { p_assessment_id: string }
        Returns: boolean
      }
      list_guests_admin: {
